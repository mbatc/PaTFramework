...
{
public:
	C3DPlane(CVector3 p_1 = CVector3(), CVector3 p_2 = CVector3(), CVector3 p_3 = CVector3(), CVector3 p_4 = CVector3()) {
	...
	void		set_point(CVector3 p, int index) { if (!valid_index(index)) return;  m_point[index] = p; update_plane(); }
